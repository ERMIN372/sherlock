...
const en: Dict = {
  ...
  "auth.forgotSent": "If that email exists, we've sent a reset link.",
  "auth.backToLogin": "Back to log in",
  "auth.or": "or",
  "auth.oauth.yandex": "Continue with Yandex",
  "auth.oauth.vk": "Continue with VK",
  ...
  "auth.err.bad_token": "Reset link is invalid or expired.",
  "auth.err.generic": "Something went wrong. Please try again.",
  "auth.oauthError": "Sign-in failed. Please try again.",
...
const ru: Dict = {
  ...
  "auth.forgotSent": "Если такой email существует, мы отправили ссылку для сброса.",
  "auth.backToLogin": "Назад ко входу",
  "auth.or": "или",
  "auth.oauth.yandex": "Войти через Яндекс",
  "auth.oauth.vk": "Войти через ВКонтакте",
  ...
  "auth.err.bad_token": "Ссылка сброса недействительна или истекла.",
  "auth.err.generic": "Что-то пошло не так. Попробуйте ещё раз.",
  "auth.oauthError": "Не удалось войти. Попробуйте ещё раз.",
  "reset.title": "Новый пароль",
  "reset.password": "Новый пароль",
  "reset.submit": "Сохранить пароль",
  "reset.success": "Пароль обновлён — вы вошли.",
  "reset.invalid": "Ссылка сброса недействительна или истекла.",
  "reset.home": "Перейти в Sherlock",
